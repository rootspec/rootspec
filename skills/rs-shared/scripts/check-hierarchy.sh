...
# Check each level
[[ -f "$SPEC_DIR/01.PHILOSOPHY.md" ]] && check_file "$SPEC_DIR/01.PHILOSOPHY.md" 1
[[ -f "$SPEC_DIR/02.TRUTHS.md" ]] && check_file "$SPEC_DIR/02.TRUTHS.md" 2
[[ -f "$SPEC_DIR/03.INTERACTIONS.md" ]] && check_file "$SPEC_DIR/03.INTERACTIONS.md" 3
