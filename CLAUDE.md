...
9. `CONVENTIONS/technical.md` — Stack, code patterns, API, testing (created by /rs-impl)
10. `CONVENTIONS/visual.md` — Component library, tokens, layout, responsive (created by /rs-impl)
