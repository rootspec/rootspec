...
|-------|------|---------|--------------|----------|------------|
| **1: First Principles** | 📘 | WHY the product exists | "What problem must we solve?" | Founders, designers, domain experts | External only |
...
**Purpose:** Philosophical, psychological, and experiential foundations that should _never_ change.

**Key Contents:**
- Mission statement ("Why this product must exist")
- Core emotional/functional goals
...
| Level                                  | Can Reference                                |
| -------------------------------------- | -------------------------------------------- |
| **Level 1** (First Principles)         | External resources only                      |
...
├── 01.FIRST_PRINCIPLES.md        # Why the product exists
...
# -----------------------------------------------------------------------------
# Inviolable Constraints (from L1 First Principles)
# -----------------------------------------------------------------------------
# @spec_source: 01.FIRST_PRINCIPLES.md

streak:
  enabled: false
  # @inviolable: true
  # @rationale: L1 principle "Never create guilt" - no punishment for breaks
  # @spec_source: 01.FIRST_PRINCIPLES.md:23
...
1. **"What problem does this product solve, and why must it exist?"** — Focus on user pain and transformation, not features
2. **"What emotional state should users feel when using this product?"** — Joy? Empowered? Calm? Confident?
3. **"What principles would you never violate, even if it cost features or users?"** — Identify true constraints
4. **"Who is this NOT for? What will this product NOT do?"** — Define boundaries through exclusion
5. **"If this product succeeds, how will users' lives be different in 6 months?"** — Validate long-term impact
...
| **L1** | Vague emotional goals | "Users should feel good" | "Specific emotion? Empowered? Calm? Accomplished?" |
