...
export async function promptsCommand(name, options) {
    try {
...
async function runPromptsCommand(name, options) {
...
async function runCypressMergePrompt() {
...
async function getAdoptionApproach() {
 ...
 */
async function runValidatePrompt() {
    const cwd = process.cwd();
    console.log(chalk.bold('\n✅ Validate RootSpec\n'));
 ...
 */
async function runAddFeaturePrompt() {
    const cwd = process.cwd();
...
async function findSpecDirectory() {
    const cwd = process.cwd();
...
async function extractDesignPillars(specDir) {
    const cwd = process.cwd();
...
async function extractStableTruths(specDir) {
    const cwd = process.cwd();
...
async function listSystems(specDir) {
    const cwd = process.cwd();
...
async function runInitPrompt() {
    ...
    const filledPrompt = promptContent.replace('[Brief description of your product concept]', productIdea);
    console.log(filledPrompt);
    console.log();
    console.log(chalk.gray('─'.repeat(60)));
    console.log();
 ...
 */
async function runMigratePrompt() {
 ...
 */
async function runGenerateDocsPrompt() {
    ...
    const filledPrompt = promptContent.replace('[Select one or more document types from above, or specify custom requirements]', docType);
    console.log(filledPrompt);
    console.log();
    console.log(chalk.gray('─'.repeat(60)));
    console.log();
