...
Complete prompt for applying the Hierarchical Specification Framework v3.6.0 to an existing codebase or partially-built product.
...
```
I have copied 00.SPEC_FRAMEWORK.md (Hierarchical Specification Framework v3.6.0)
