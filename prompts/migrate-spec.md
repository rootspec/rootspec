...
v[OLD_VERSION]. I've updated 00.SPEC_FRAMEWORK.md to v3.5.0.
...
1. **Identify Breaking Changes**
   - Read CHANGELOG.md between v[OLD_VERSION] and v3.5.0
...
4. **Validate Migrated Spec**
   - Ensure it follows v3.5.0 rules from 00.SPEC_FRAMEWORK.md
