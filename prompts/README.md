...
Complete, detailed prompts for working with the Hierarchical Specification Framework v3.5.1.
...
These prompts are designed for **Hierarchical Specification Framework v3.5.1**.
