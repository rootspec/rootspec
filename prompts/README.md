...
Complete, detailed prompts for working with the Hierarchical Specification Framework v3.0.0.
...
These prompts are designed for **Hierarchical Specification Framework v3.0.0**.
