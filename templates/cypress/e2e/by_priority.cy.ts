/**
 * Runtime test generator for priority-based user stories.
 *
 * This file dynamically loads all YAML user stories from the
 * 05.IMPLEMENTATION/USER_STORIES/by_priority/ directory and generates
 * Cypress tests for MVP, SECONDARY, and ADVANCED stories.
 *
 * Test organization:
...
/**
 * Load all YAML story files from the by_priority directory.
 *
